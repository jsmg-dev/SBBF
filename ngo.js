...
const translations = {
    en: {
        ...
        knowingName: "SBB",
        aboutP1: "Shree Banke Bihari Foundation is a registered non-profit organisation based in Rajasthan, working to drive meaningful change through gau seva, child sponsorship, women empowerment, and humanitarian outreach. With provisional 12A, 80G, and Darpan registration, the Foundation ensures transparency and accountability in every initiative.",
        aboutP2: "We design and implement structured programs across cow welfare, education, livelihoods, and community development — each rooted in grassroots realities and built for long-term impact.",
        aboutP3: "Through food distribution drives, gaushala care, skill training, and direct support for essentials, SBB Foundation creates lasting transformation that inspires volunteers, donors, and communities to serve those in need.",
        whatWeDo: "What We Do",
        ...
        slide1Title: "Gau Seva & Compassionate Care",
        slide1Lead: "Building a modern Gaushala and Cow Hospital for injured, abandoned, and needy cattle across Rajasthan.",
