...
const translations = {
    en: {
        ...
        donateNow: "Contribute",
        adoptCow: "Adopt a Cow",
        sponsorChild: "Sponsor a Child",
        volunteer: "Volunteer",
        aboutNav: "About",
        donateNav: "Contribute",
        knowingLabel: "Knowing",
        knowingName: "SBB",
        aboutP1: "Shree Banke Bihari Foundation (SBB Foundation) is a non-profit organization dedicated to serving humanity through compassion, dignity, and sustainable development. Our mission is to promote Gau Seva by establishing modern Gau Hospitals that provide medical care, rehabilitation, and lifelong protection to sick, injured, and abandoned cows. We are equally committed to supporting vulnerable members of society through Orphanages, which provide children with a safe, nurturing environment and quality education, and Old Age Homes, where senior citizens receive compassionate care, respect, and dignity..",
        aboutP2: "Our vision extends beyond individual initiatives. We aim to develop an integrated Service, Spiritual, and Cultural Campus that brings together a Gau Hospital, Gaushala, Temple, Orphanage, Old Age Home, meditation spaces, and beautifully landscaped surroundings. This unique destination will serve as a center for social service, spirituality, Indian culture, and environmental harmony, while also attracting pilgrims, tourists, volunteers, and researchers from across the country. Through this model of compassion and community service, SBB Foundation aspires to create a lasting legacy that inspires future generations and contributes to a more caring and inclusive society.",
        whatWeDo: "What We Do",
        whatWeDoLead: "Outcome-driven programs across gau seva, education, and women's empowerment.",
        cowCardDesc: "Safe shelter, fodder, and veterinary care with monthly donor updates.",
        childCardDesc: "Education, meals, uniforms, and school support for children in need.",
        womenCardDesc: "Skill training, SHGs, and micro-enterprise support for women.",
        humanitarianTitle: "Humanitarian Outreach",
        humanitarianDesc: "Food, blankets, and essentials for vulnerable families.",
        learnMore: "Learn more",
        impactTitle: "Impact Created With Your Support",
        impactLead: "Your generosity is helping us reach communities across Rajasthan.",
        slide1Title: "Serving Gaumata, Serving Humanity",
        slide1Lead: "Creating an integrated spiritual and humanitarian campus where Gaushala, Gau Hospital, Temple, Orphanage, Old Age Home, and nature come together to serve humanity, preserve Indian culture, and inspire generations through compassion and selfless service.",
        slide2Title: "Adopt a Cow. Serve with Devotion.",
        slide2Lead: "Safe shelter, nutritious fodder, and veterinary care with monthly photo updates for every donor.",
        slide3Title: "Learners Today, Leaders Tomorrow.",
        slide3Lead: "Sponsor a child's education, nutrition, and safe learning environment with regular progress updates.",
        slide4Title: "Empowered Women, Strong Communities.",
        slide4Lead: "Skill training, SHG formation, and livelihood support for women's economic independence.",
        slide5Title: "Serving Humanity, One Meal at a Time.",
        slide5Lead: "Food distribution, blankets, and essentials reaching the most vulnerable families in need.",
        campaignsTitle: "Ways to Contribute",
        ctaBandTitle: "Be a Part of the Change",
        ctaBandLead: "Join us in creating sustainable impact through meaningful collaboration and support.",
        ...
        teamTitle: "The People Behind Our Mission",
        teamLead: "Committed to Gau Seva, Community Welfare & Sustainable Development",
        tierChairman: "Chairman",
        tierViceChairmen: "Vice Chairmen",
        tierDirectors: "Directors",
        tierTeam: "Team",
    ...
    hi: {
        ...
        teamTitle: "हमारे मिशन के पीछे समर्पित लोग",
        teamLead: "गौ सेवा, समुदाय कल्याण और सतत विकास के प्रति प्रतिबद्ध",
        tierChairman: "अध्यक्ष",
        tierViceChairmen: "उपाध्यक्ष",
        tierDirectors: "निदेशक",
        tierTeam: "टीम",
...
eventImages.unshift(
    ...
    "images/event/F1.jpeg",
    "images/event/F2.jpeg",
    "images/event/F3.jpeg",
    "images/event/F4.jpeg",
    "images/event/F5.jpeg",
"images/event/F6.jpeg",
"images/event/F7.jpeg",
"images/event/F8.jpeg",
"images/event/F9.jpeg",
"images/event/F10.jpeg",
"images/event/F11.jpeg",
"images/event/F12.jpeg",
"images/event/F13.jpeg",
"images/event/F14.jpeg",
"images/event/F15.jpeg",
"images/event/F16.jpeg",
"images/event/F17.jpeg",
"images/event/F18.jpeg",
"images/event/F19.jpeg",
"images/event/F20.jpeg",
"images/event/F22.jpeg",
"images/event/F23.jpeg",
"images/event/F24.jpeg",
"images/event/F25.jpeg",
"images/event/F26.jpeg",
"images/event/F28.jpeg",
"images/event/F29.jpeg",
    "images/event/K8.jpeg",
    "images/event/K9.jpeg",
    "images/event/K10.jpeg",
    "images/event/K11.jpeg",
    "images/event/K12.jpeg",
    "images/event/K13.jpeg",
